...
<p class="has-24292-eff-color has-cyan-bluish-gray-background-color has-text-color has-background has-1-125-rem-font-size">./example1.txt<br>./folder1/example3.txt<br>./folder1/folder3/example5.txt</p>
</details>
</details>
